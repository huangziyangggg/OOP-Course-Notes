...
本课程 \textbf{Object Oriented Programming}（课程代码 22EM31202C）是哈尔滨工业大学与法国里昂商学院联合举办的\textbf{应用数据科学本科项目（BSc in Applied Data Science）}一年级春季学期专业核心课，共 32 学时、2 学分，考核方式为\textbf{考试课}。课程由 \textbf{Imène BRIGUI} 老师等两位教师联合讲授。
...
\begin{concept}{What is a Set? / 什么是集合？}
    ...
    \begin{itemize}[itemsep=0.3em]
        ...
        \item \textbf{Unchangeable / 不可变内容}：You cannot change items, but you can add or remove items.
